class CreateAssessments < ActiveRecord::Migration[5.0]
  def change
    create_table :assessments do |t|
      ...
      t.integer :last_six_months_been_in_home_of_someone_from_different_neighborhood
      t.integer :last_six_months_had_friend_from_different_neighborhood_in_my_home
      ...
      t.belongs_to :individual, foreign_key: true
