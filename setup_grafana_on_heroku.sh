...
# # SQL notes for dashboards
# # SELECT
# #   individuals.first_name, individuals.last_name, latest_assessments.date_collected
# # FROM
# #   (SELECT
...
# #   individuals
# # ON
# #   individuals.id = latest_assessments.individual_id
...
# #   assessments.date_collected = latest_assessments.date_collected
